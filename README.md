...
|        Scenario        | Average Daily Demand ($\bar{D}$) | Standard Deviation ($\sigma_D$)|Reorder Point (ROP)|
|------------------------|----------------------------------|--------------------------------|-------------------|
|  ALL Demand (Initial)  |          102.01                  |       39.17                    |      999          |
|NORMAL Demand (Filtered)|          100.23                  |       39.899                   |      988          |
...
[![View ROP Plot All](visuals/ROP_plot_SKU_18_ALL.png)](visuals/ROP_plot_SKU_18_ALL.png)

[![View ROP Plot Normal](visuals/ROP_plot_SKU_18_NORMAL.png)](visuals/ROP_plot_SKU_18_NORMAL.png)
